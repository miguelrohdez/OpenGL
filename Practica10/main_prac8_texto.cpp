...
CTexture t_metal01;
CTexture t_wood;
CTexture t_white_wood;
CTexture t_ore_metal;
CTexture t_wall_1;
CTexture t_wall_2;
CTexture t_rare;*/
CTexture t_dado;
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_wood.LoadTGA("wood.tga");
	t_wood.BuildGLTexture();
	t_wood.ReleaseImage();

	t_rare.LoadTGA("somet.tga");
	t_rare.BuildGLTexture();
	t_rare.ReleaseImage();

	t_ore_metal.LoadTGA("metal2.tga");
	t_ore_metal.BuildGLTexture();
	t_ore_metal.ReleaseImage();

	t_wall_1.LoadTGA("wall.tga");
	t_wall_1.BuildGLTexture();
	t_wall_1.ReleaseImage();

	t_wall_2.LoadTGA("wall2.tga");
	t_wall_2.BuildGLTexture();
	t_wall_2.ReleaseImage();

	t_white_wood.LoadTGA("whitewood.tga");
	t_white_wood.BuildGLTexture();
	t_white_wood.ReleaseImage();
	*/
...
void prisma6 (GLuint textura1, GLuint textura2, GLuint textura3, GLuint textura4, GLuint textura5, GLuint textura6)  //Funcion creacion prisma
{
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		//Poner código aquí
		//prisma6(t_metal01.GLindex, t_wood.GLindex, t_white_wood.GLindex, t_rare.GLindex, t_wall_1.GLindex, t_wall_2.GLindex );
		prismaAll(t_dado.GLindex);
