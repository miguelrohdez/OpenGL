...
void CFiguras::Wall (float altura, float largo, float profundidad, GLuint textura1, GLuint textura2, GLuint textura3, GLuint textura4, GLuint textura5, GLuint textura6)  //Funcion creacion prisma
{

	GLfloat vertice[8][3] = {
		{ 1.0*largo ,-1.0*altura, 1.0*profundidad },    //Coordenadas Vértice 1 V1
		{ -1.0*largo ,-1.0*altura , 1.0*profundidad },    //Coordenadas Vértice 2 V2
		{ -1.0*largo ,-1.0*altura , -1.0*profundidad },    //Coordenadas Vértice 3 V3
		{ 1.0*largo ,-1.0*altura , -1.0*profundidad },    //Coordenadas Vértice 4 V4
		{ 1.0*largo ,1.0*altura , 1.0*profundidad },    //Coordenadas Vértice 5 V5
		{ 1.0*largo ,1.0*altura , -1.0*profundidad },    //Coordenadas Vértice 6 V6
		{ -1.0*largo ,1.0*altura , -1.0*profundidad },    //Coordenadas Vértice 7 V7
		{ -1.0*largo ,1.0*altura , 1.0*profundidad },    //Coordenadas Vértice 8 V8
	};
