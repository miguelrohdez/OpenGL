...
void CFiguras::cono(float altura, float radio, int resolucion, GLuint text)
{
	...
	for(int i=0; i <resolucion; i++)
	{
		...
		glBegin(GL_TRIANGLES);
			...
			glTexCoord2f(0.5, 1.0f);	glVertex3f(0.0,altura,0.0);
		glEnd();
	}
}

void CFiguras::c4_cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral)
{
	...
	float angulo = 1.570971 / resolucion;
...
void CFiguras::m_cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral)
{
...
void CFiguras::cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral)
{
...
void CFiguras::cilindro_nb(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral)
{
