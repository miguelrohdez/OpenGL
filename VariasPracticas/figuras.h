...
class CFiguras
{
	...
	void cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral);	//Funcíon creacion cilindro
	void cilindro_nb(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral);	//Funcíon creacion cilindro
	void m_cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral);	//Funcíon creacion medio cilindro
	void c4_cilindro(float radio, float altura, int resolucion, GLuint Base, GLuint Lateral);	//Funcíon creacion 1/4 cilindro
