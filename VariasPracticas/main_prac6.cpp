...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glutWireSphere(1.0, 20, 20);  //Draw Tierra (radio,H,V);
	glPopMatrix();

	glRotatef(moon, 1.0, 0.0, 0.0);
	glTranslatef(0.0, 2.5, 0.0);
	glColor3f(0.0, 0.0, 1.0); //Luna
	glutWireSphere(0.3, 20, 20);  //Draw Luna (radio,H,V);
	...
	glRotatef(date, 0.0, 1.0, 0.0);
	glColor3f(1.0, 0.0, 0.0); //Marte
	glutWireSphere(0.8, 20, 20);  //Draw Marte (radio,H,V);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glutWireSphere(2.0, 20, 20);//Saturno
