...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_esfera3.LoadTGA("rand1.tga");
	t_esfera3.BuildGLTexture();
	t_esfera3.ReleaseImage();

	t_esfera4.LoadTGA("rand2.tga");
	t_esfera4.BuildGLTexture();
	t_esfera4.ReleaseImage();

	t_esfera5.LoadTGA("rand3.tga");
	t_esfera5.BuildGLTexture();
	t_esfera5.ReleaseImage();

	t_esfera6.LoadTGA("rand4.tga");
	t_esfera6.BuildGLTexture();
	t_esfera6.ReleaseImage();
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			/*glPushMatrix();
				...
				miguel.cono(4.5f, 1.0f, 4, 0);
				glTranslatef(9.0, 0.0, 0.0);
				glColor3f(1.0, 0.0, 0.0);
				miguel.esfera(3.0, 20, 20, 0);
			glPopMatrix();*/
			...
			glPushMatrix();
				...
				glAlphaFunc(GL_GREATER, 0.1);
				glPushMatrix();
					glTranslatef(1.7,1.0,0.0);
					miguel.esfera(.3,10,10,t_esfera.GLindex);//1
				glPopMatrix();
				glPushMatrix();
					glTranslatef(-0.9, 2.8, 0.0);
					miguel.esfera(.3, 10, 10, t_esfera2.GLindex);//2
				glPopMatrix();
				glPushMatrix();
				glTranslatef(1.0, 2.5, 0.0);
				miguel.esfera(.3, 10, 10, t_esfera3.GLindex);//3
				glPopMatrix();
				glPushMatrix();
				glTranslatef(-1.5, 1.5, 0.0);
				miguel.esfera(.3, 10, 10, t_esfera4.GLindex);//4
				glPopMatrix();
				glPushMatrix();
					glTranslatef(0.0, 4.0, 0.0);
					miguel.esfera(.3, 10, 10, t_esfera5.GLindex);//5
				glPopMatrix();
				glDisable(GL_ALPHA_TEST);
				miguel.cono(4.0,2.0,20,t_hojas.GLindex);
			glPopMatrix();
			miguel.cilindro(0.5, 4.0,15.0,t_tronco.GLindex);
			glPopMatrix();

			glPushMatrix();
			glTranslatef(-15.0, 4.0, -6.0);
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("Práctica 9"); // Nombre de la Ventana
