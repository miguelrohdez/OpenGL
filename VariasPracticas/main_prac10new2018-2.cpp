...
void animacion()
{
	...
	if (g_fanimacion) {
		...
		/*if ((movKit > -100) && (reversa == 1) && (arriba == 0)) {
			movLlanta -= 1.5;
			movKit -= 0.3;
			if (movKit < 100) {
				reversa = 0;
		...
		}else if ((movKitY < 80) && (reversa == 0) && (arriba == 0)) {
			movLlanta += 1.5;
			movKitY += 0.3;
			if (movKitY > 80) {
				arriba = 1;
		...
		if ((movKit < 100) && (reversa == 0) && (arriba == 1)) {
			movLlanta += 1.5;
			movKit += 0.3;
			if (movKit > 100) {
				reversa = 0;
			...
			if ((movKitY > 0) && (reversa == 0) && (arriba == 1)) {
				movLlanta -= 1.5;
				movKitY -= 0.3;
				if (movKitY < 0) {
					reversa = 2;
