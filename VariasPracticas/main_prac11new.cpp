...
#define MAX_FRAMES 15 //Cuadros Clave Disponibles
int i_max_steps = 90;
int i_curr_steps = 0;
...
FRAME KeyFrame[MAX_FRAMES]; //Instanciacion del arreglo de Frames
...
void saveFrame ( void ) //Guarda las posiciones a la estructura del frame
{
	...
	KeyFrame[FrameIndex].movBrazo2 = movBrazo2;
	KeyFrame[FrameIndex].movPie2 = movPie2;
...
void resetElements( void )
{
	...
	movBrazo2 = KeyFrame[0].movBrazo2;
	movPie2 = KeyFrame[0].movPie2;

}

//Se encarga de hacer el calculo de la interpolacion
//Valor de los cuadros intermedios, como sub animaciones
void interpolation ( void )
{
	...
	KeyFrame[playIndex].movBrazoInc = (KeyFrame[playIndex + 1].movBrazo - KeyFrame[playIndex].movBrazo) / i_max_steps;
	KeyFrame[playIndex].movBrazo2Inc = (KeyFrame[playIndex + 1].movBrazo2 - KeyFrame[playIndex].movBrazo2) / i_max_steps;
	KeyFrame[playIndex].movPie2Inc = (KeyFrame[playIndex + 1].movPie2 - KeyFrame[playIndex].movPie2) / i_max_steps;
...
void monito()
{
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix();//Cuello
			...
			fig7.cilindro(0.25, 0.25, 15, 0,0);
			glPushMatrix();//Cabeza
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			//Sumar el incremento a la variable para que se vea el movimiento del brazo
			movBrazo += KeyFrame[playIndex].movBrazoInc; 
			movBrazo2 += KeyFrame[playIndex].movBrazo2Inc;
			movPie2 += KeyFrame[playIndex].movPie2Inc;
