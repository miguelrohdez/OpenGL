...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	/*
	t_Rand1.LoadTGA("rand1.tga");
	t_Rand1.BuildGLTexture();
	t_Rand1.ReleaseImage();

	t_letras.LoadTGA("letras.tga");
	t_letras.BuildGLTexture();
	t_letras.ReleaseImage();

	t_Rand3.LoadTGA("rand3.tga");
	t_Rand3.BuildGLTexture();
	t_Rand3.ReleaseImage();

	t_Rand4.LoadTGA("rand4.tga");
	t_Rand4.BuildGLTexture();
	t_Rand4.ReleaseImage();

	t_Rand5.LoadTGA("rand5.tga");
	t_Rand5.BuildGLTexture();
	t_Rand5.ReleaseImage();

	t_Rand6.LoadTGA("rand6.tga");
	t_Rand6.BuildGLTexture();
	t_Rand6.ReleaseImage();
	...
	*/
	...
	/*
	t_Rand.LoadTGA("rand.tga");
	t_Rand.BuildGLTexture();
	t_Rand.ReleaseImage();*/
...
void prismaAll(GLuint textura1)  //Funcion creacion prisma
{
	...
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.25f, 0.66f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5f, 0.66f); glVertex3fv(vertice[5]);
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	//	prisma(t_Rand1.GLindex, t_letras.GLindex, t_Rand3.GLindex, t_Rand4.GLindex, t_Rand5.GLindex, t_Rand6.GLindex);
		prismaAll(t_dado.GLindex); //correcto
		//Poner código aquí
	/*	glBindTexture(GL_TEXTURE_2D, t_letras.GLindex);
		glBegin(GL_QUADS);
		glTexCoord2f(0.0, 0.0); glVertex3f(-4.0, 0.0, 0.0);
		glTexCoord2f(2.0, 0.0);	glVertex3f(4.0, 0.0, 0.0);
		glTexCoord2f(1.0, 5.0); glVertex3f(4.0, 5.0, 0.0);
		glTexCoord2f(0.0, 1.0); glVertex3f(-4.0, 5.0, 0.0);
