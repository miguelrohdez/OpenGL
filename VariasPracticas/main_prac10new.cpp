...
void Pared(float altura, float largo, float profundidad, 
	...
	GLuint textura4, GLuint textura5, GLuint textura6)  //Funcion Pared
{
	...
	glTexCoord2f(0.0f, 1.0); glVertex3fv(vertice[1]);
	glEnd();
	...
	glTexCoord2f(0.5, 1.0); glVertex3fv(vertice[5]);
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPopMatrix();
			...
			glPushMatrix(); //prueba
			glTranslatef(0.0, 13.0, -7.0);
			Pared(0.5,0.2,0.2,text1.GLindex, text2.GLindex, text3.GLindex, text4.GLindex, text5.GLindex, text6.GLindex);
			glPopMatrix();

			glPushMatrix(); //prueba
			//glTranslatef(0.0, 15.0, -7.0);
			//glLineWidth(10.0);
			glBegin(GL_LINE);
			glColor3f(1, 1, 1);
			glVertex3f(-15.0, -0.3f,1.0);
			glVertex3f(15.0f, 0.3f, 1.0);
			glEnd();
			glPopMatrix();
